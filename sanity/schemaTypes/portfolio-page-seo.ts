...
export const portfolioPageSeo = defineType({
	name: "portfolioPageSeo",
	title: "Portfolio Page SEO & Settings",
	type: "document",
	groups: [
	...
	fields: [
		defineField({
			...
			title: "Page Title",
			type: "string",
			description: "The main title for the portfolio page",
		}),
		defineField({
			name: "description",
	...
	preview: {
		...
		prepare({ title, subtitle }) {
			return {
				title: title || "Portfolio Page SEO & Settings",
