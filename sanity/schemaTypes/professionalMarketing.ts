...
const baseServiceSlug = "professionals" as const
...
export const professionalMarketingServiceType = defineType({
	name: "professionalMarketingService",
	...
	preview: {
		...
		prepare({ title }) {
			return {
				title: title ?? "Professionals Marketing",
			}
		},
	},
})
