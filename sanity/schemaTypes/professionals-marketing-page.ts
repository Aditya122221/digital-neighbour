...
export const professionalsMarketingPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Service Name",
      type: "string",
      description: "Display name for this Professionals Marketing service",
      group: "basic",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          hidden: ({ document }) => document?.slug?.current !== "professionals",
        }),
        defineField({
          name: "professionals",
          ...
          of: [
            {
              ...
              fields: [
                ...
                defineField({
                  ...
                  type: "string",
                  description: "URL-friendly identifier for the professional",
                  validation: (Rule) => Rule.required(),
                }),
                defineField({
                  name: "image",
                  ...
                  type: "image",
                  options: { hotspot: true },
                  description: "Image representing this professional",
                }),
              ],
              preview: {
                select: {
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: "text",
          rows: 3,
          description: "Optional subheading (can be empty)",
        }),
        defineField({
          name: "items",
    ...
    defineField({
      ...
      type: "string",
      group: "services",
      description: "Main service name (e.g., 'Professionals Marketing')",
    }),
  ...
  preview: {
    ...
    prepare({ title, subtitle }) {
      return {
        title: title || "Professionals Marketing Service Page",
