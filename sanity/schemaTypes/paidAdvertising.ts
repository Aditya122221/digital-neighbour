...
const baseServiceSlug = "paid-advertisement" as const

const paidAdServiceSlugs = [
	"google-ads",
	"meta-ads",
	"linkedin-ads",
	"youtube-ads",
...
export const paidAdvertisingServiceType = defineType({
	name: "paidAdvertService",
	...
	preview: {
		...
		prepare({ title }) {
			return {
				title: title ?? "Paid Advert Service",
			}
		},
	},
})
