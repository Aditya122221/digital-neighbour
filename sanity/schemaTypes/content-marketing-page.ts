...
export const contentMarketingPage = defineType({
	...
	fields: [
		...
		defineField({
			...
			title: "Service Name",
			type: "string",
			description: "Display name for this content marketing service (e.g., 'Content Marketing', 'Content Strategy', 'Copywriting')",
			group: "basic",
		...
		defineField({
			...
			title: "Service Slug",
			type: "slug",
			description: "URL-friendly identifier (e.g., 'content-marketing', 'content-strategy', 'copywriting')",
			group: "basic",
			options: {
				source: "serviceName",
				maxLength: 96,
		...
		defineField({
			...
			type: "string",
			group: "services",
			description: "Main service name (e.g., 'Content Marketing', 'Content Strategy', 'Copywriting')",
		}),
		defineField({
			name: "serviceCards",
			title: "Service Cards",
	...
	preview: {
		...
		prepare({ title, subtitle }) {
			return {
				title: title || "Untitled Content Marketing Service",
