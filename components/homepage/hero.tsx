...
export default function Hero() {
	...
	return (
		...
		>
			...
			<div className="absolute inset-0 bg-green1" />
			...
			>
				<h1 className="text-4xl md:text-6xl lg:text-7xl font-semibold leading-tight text-balance text-center font-cal-sans tracking-wide text-white">
					{"Borderless "
						.split(" ")
						.map((word, wordIndex) => {
							if (!word) return null
				...
				<p className="mt-8 text-lg md:text-xl lg:text-3xl font-semibold leading-tight text-pretty max-w-3xl mx-auto text-center text-white">
